import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,d as e}from"./app-21664fcf.js";const i={},t=e(`<h1 id="变量和常量" tabindex="-1"><a class="header-anchor" href="#变量和常量" aria-hidden="true">#</a> 变量和常量</h1><h2 id="go语言中变量的声明" tabindex="-1"><a class="header-anchor" href="#go语言中变量的声明" aria-hidden="true">#</a> Go语言中变量的声明</h2><p>Go语言变量是由字母、数字、下划线组成，其中首个字符不能为数字。Go语言中关键字和保留字都不能用作变量名</p><p>Go语言中变量需要声明后才能使用，同一作用域内不支持重复声明。并且Go语言的变量声明后必须使用。</p><p>变量声明后，没有初始化，打印出来的是空</p><h2 id="如何定义变量" tabindex="-1"><a class="header-anchor" href="#如何定义变量" aria-hidden="true">#</a> 如何定义变量</h2><h3 id="方式1" tabindex="-1"><a class="header-anchor" href="#方式1" aria-hidden="true">#</a> 方式1：</h3><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">var</span> 变量名 <span class="token operator">=</span> 值
