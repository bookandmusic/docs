import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as c,c as l,a as n,b as s,e,d as t}from"./app-d4f00f12.js";const i={},u=t(`<p>在使用Celery至异步任务处理时，如果存在多种类型的任务，并且我们希望用不同的Worker来处理不同类型的任务时，应该如何处理呢？<br> 本文将会讲解如何利用Celery将任务分配至不同队列，并使用不同的Worker来处理指定类型的任务。</p><h2 id="celery-app创建" tabindex="-1"><a class="header-anchor" href="#celery-app创建" aria-hidden="true">#</a> celery app创建</h2><blockquote><p>celery版本是3.x</p></blockquote><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">from</span> __future__ <span class="token keyword">import</span> absolute_import
