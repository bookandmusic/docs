import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,d as e}from"./app-505788a4.js";const t={},p=e(`<h1 id="视图类装饰器" tabindex="-1"><a class="header-anchor" href="#视图类装饰器" aria-hidden="true">#</a> 视图类装饰器</h1><h2 id="装饰器" tabindex="-1"><a class="header-anchor" href="#装饰器" aria-hidden="true">#</a> 装饰器</h2><blockquote><p>定义装饰器，判断请求头中，是否存在用户名？</p><ul><li>存在，认为用户是合法用户，允许通过</li><li>不存在，拒绝用户访问</li></ul></blockquote><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">from</span> flask <span class="token keyword">import</span> request
