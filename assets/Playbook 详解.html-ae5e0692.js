import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,d as e}from"./app-e6ea23bd.js";const t={},p=e(`<h1 id="playbook-详解" tabindex="-1"><a class="header-anchor" href="#playbook-详解" aria-hidden="true">#</a> Playbook 详解</h1><h3 id="流程控制语句" tabindex="-1"><a class="header-anchor" href="#流程控制语句" aria-hidden="true">#</a> 流程控制语句</h3><p>条件判断在ansible任务中的使用频率非常高。我们可以根据一些条件的不一样执行不同的task。</p><h4 id="when条件判断" tabindex="-1"><a class="header-anchor" href="#when条件判断" aria-hidden="true">#</a> when条件判断</h4><p>很多任务只有在特定条件下才能执行，这就是when语句发挥作用的地方。</p><p>一个简单的实例，关闭掉ip地址为10.0.102.162服务器上的mysql服务，如下：</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token punctuation">---</span>
