import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as l,c,a as n,b as s,e,d as i}from"./app-8955ab6e.js";const d={},p=n("h1",{id:"idoc",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#idoc","aria-hidden":"true"},"#"),s(" idoc")],-1),r={href:"https://github.com/jaywcjlove/idoc",target:"_blank",rel:"noopener noreferrer"},u=i(`<blockquote><p>依赖 node.js 环境。</p></blockquote><p>特点：<br> 1、简单小巧，支持自动生成目录。有几个主题可以选择。<br> 2、不支持插件。<br> 3、原理是将 Markdown 文件编译生成 html 文件。</p><h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h3><p>全局安装：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">sudo</span> <span class="token function">npm</span> <span class="token function">install</span> idoc <span class="token parameter variable">-g</span>
