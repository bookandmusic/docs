import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,d as e}from"./app-45b6ee47.js";const t={},p=e(`<h1 id="请求地址参数查询" tabindex="-1"><a class="header-anchor" href="#请求地址参数查询" aria-hidden="true">#</a> 请求地址参数查询</h1><p>接下来我们将使用最简单的形式来演示search API。</p><h2 id="索引、类型查询" tabindex="-1"><a class="header-anchor" href="#索引、类型查询" aria-hidden="true">#</a> 索引、类型查询</h2><p>首先，我们先通过搜索公司的所有员工来演示搜索API的应用。</p><div class="language-http line-numbers-mode" data-ext="http"><pre class="language-http"><code>GET /employee/_search
