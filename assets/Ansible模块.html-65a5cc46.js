import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e}from"./app-5fd09ffe.js";const t={},p=e(`<h1 id="ansible模块" tabindex="-1"><a class="header-anchor" href="#ansible模块" aria-hidden="true">#</a> Ansible模块</h1><h2 id="条件判断" tabindex="-1"><a class="header-anchor" href="#条件判断" aria-hidden="true">#</a> 条件判断</h2><h3 id="assert" tabindex="-1"><a class="header-anchor" href="#assert" aria-hidden="true">#</a> assert</h3><p><code>that</code>：指定需要判断的条件，可以指定多个条件，条件之间关系是与</p><p><code>fail_msg</code>：当条件为 <code>false</code>，输出错误信息</p><p><code>success_msg</code>：当条件为 <code>true</code>时，输出成功信息</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token punctuation">---</span>
