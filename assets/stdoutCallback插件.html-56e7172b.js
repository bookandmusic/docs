import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,d as t}from"./app-505788a4.js";const p={},e=t(`<h1 id="stdoutcallback插件" tabindex="-1"><a class="header-anchor" href="#stdoutcallback插件" aria-hidden="true">#</a> stdoutCallback插件</h1><p><code>stdout_callback</code>是Ansible Playbook中的一个回调插件，用于在执行Playbook期间向标准输出流打印信息。该插件提供了一种方式来自定义打印输出格式，并允许用户在执行期间观察Ansible任务的进度。</p><h2 id="自定义stdout-callback插件" tabindex="-1"><a class="header-anchor" href="#自定义stdout-callback插件" aria-hidden="true">#</a> 自定义stdout_callback插件</h2><p>以下是一个示例，自定义<code>stdout_callback</code>插件,隐藏日志中的sql命令：</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> os
