import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,d as e}from"./app-505788a4.js";const p={},t=e(`<h1 id="图片上传与展示" tabindex="-1"><a class="header-anchor" href="#图片上传与展示" aria-hidden="true">#</a> 图片上传与展示</h1><p>通过以下demo简单演示在flask项目中的图片上传流程。</p><h2 id="项目配置" tabindex="-1"><a class="header-anchor" href="#项目配置" aria-hidden="true">#</a> 项目配置</h2><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> os
