import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as n,d as a}from"./app-802747a1.js";const i={},l=a(`<h2 id="unit" tabindex="-1"><a class="header-anchor" href="#unit" aria-hidden="true">#</a> Unit</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># Note on units: when memory size is needed, it is possible to specify</span>
