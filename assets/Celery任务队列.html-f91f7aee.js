import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as c,c as l,a as n,b as s,d as e,e as t}from"./app-58480cea.js";const i={},u=t(`<h1 id="celery任务队列" tabindex="-1"><a class="header-anchor" href="#celery任务队列" aria-hidden="true">#</a> Celery任务队列</h1><p>在使用Celery至异步任务处理时，如果存在多种类型的任务，并且我们希望用不同的Worker来处理不同类型的任务时，应该如何处理呢？<br> 本文将会讲解如何利用Celery将任务分配至不同队列，并使用不同的Worker来处理指定类型的任务。</p><h2 id="celery-app创建" tabindex="-1"><a class="header-anchor" href="#celery-app创建" aria-hidden="true">#</a> celery app创建</h2><blockquote><p>celery版本是3.x</p></blockquote><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">from</span> __future__ <span class="token keyword">import</span> absolute_import
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>‍</p>`,4);function h(R,L){const a=o("ExternalLinkIcon");return c(),l("div",null,[u,n("blockquote",null,[n("p",null,[s("如果是 4.x以上，需要参考"),n("a",r,[s("官方文档"),e(a)]),s("，有不同的写法。")])]),d,n("blockquote",null,[n("p",null,[s("如果是 4.x以上，需要参考"),n("a",k,[s("官方文档"),e(a)]),s("，修改配置参数键名")])]),m,n("blockquote",null,[n("p",null,[s("celery3.x 使用 djcelery模块和django集成，celery4.x之后，不需要使用"),v,s("，但是如果想要动态创建定时任务及存储结果到SQL数据库中，可以使用 "),n("a",b,[_,e(a)]),s("和 "),n("a",g,[E,e(a)])])]),y])}const C=p(i,[["render",h],["__file","Celery任务队列.html.vue"]]);export{C as default};
